        ...
        $(document).ready(function () {
            $('#pak').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        success: function (data) {
                            var resp = $.map(data, function (obj) {
                                return {
                                    label: obj.name, // Displayed value
                                    value: obj.name, // Actual value selected
                                };
                            });
                            response(resp);
                        },
                ...
                select: function (event, ui) {
                    ...
                    $('#pak').val(ui.item.value);
                },
                change: function (event, ui) {
                    if (!ui.item) {
                        // Clear the field if the value is not from the list
                        $('#pak').val('');
                        alert('Please select a valid PAK from the list.');
                    }
                },
            });
        });
