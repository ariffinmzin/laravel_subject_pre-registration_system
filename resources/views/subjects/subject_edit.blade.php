                    ...
                    <div class="col-md-6">
                        ...
                        >
                            ...
                            @foreach ($credit_options as $value => $label)
                                <option
                                    value="{{ $value }}"
                                    {{ old("subject_credit", $subject->subject_credit) == $value ? "selected" : "" }}
                                >
                                    {{ $label }}
                                </option>
                            @endforeach
                    ...
                    <div class="col-md-6">
                        ...
                        >
                            ...
                            @foreach ($program_options as $value => $label)
                                <option
                                    value="{{ $value }}"
                                    {{ old("subject_program", $subject->subject_program) == $value ? "selected" : "" }}
                                >
                                    {{ $label }}
                                </option>
                            @endforeach
                    ...
                    <div class="col-md-6">
                        ...
                        >
                            ...
                            @foreach ($year_options as $value => $label)
                                <option
                                    value="{{ $value }}"
                                    {{ old("subject_year", $subject->subject_year) == $value ? "selected" : "" }}
                                >
                                    {{ $label }}
                                </option>
                            @endforeach
